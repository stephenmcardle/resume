...
{\sl Full-Stack Developer} \hfill Present \\
Turbo360 \hfill New York, NY \\
Working with the MERN stack and producing reusable serverless functions to expand the Turbo360 platform. Helping new users become accustomed to programming with the Turbo Client.

{\sl Full-Stack Developer} \hfill Present \\
Senior Design Marketplace \hfill Hoboken, NJ \\
Inventing a new system to revolutionize Senior Design courses at Stevens Institute of Technology. The website will allow professors and external clients to propose projects, instructors will manage their students, and students will sign up for projects. This online system will expedite and simplify the entire Senior Design process, as well as promote cross-discipline projects. The team uses the Agile method to organize team programming and software development.
