...
Utilized HTML5, CSS3/Bootstrap, and JavaScript to enhance the UI/UX of the HALE Sports website. Built up a Python/Django server running on Digital Ocean. Created the online registration process for new clients.

{\sl Research Assistant} \hfill May 2017 - August 2017\\
Epidemic Disease Simulator \hfill Hoboken, NJ \\
Programmed a simulator designed to track the spread of epidemic diseases with NodeJS. Based on a simulator written in C++, efficiently leveraging the application required many optimizations of JavaScript code and classes, which resulted in up to an 80\% decrease in run-time.
